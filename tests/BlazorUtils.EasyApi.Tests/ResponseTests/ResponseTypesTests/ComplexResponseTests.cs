...
public abstract class ComplexResponseTests(TestsFixture fixture) : TestsBase(fixture)
{
    ...
    public async Task Request_ForResponse_OfClassType(Product expectedResponse)
    {
...
public class Client_ComplexResponseTests(TestsFixture fixture) : TimeResponseTests(fixture)
{
...
public class Server_ComplexResponseTests(TestsFixture fixture) : TimeResponseTests(fixture)
{
